...
public class ArbolBinarioMain {
    ...
    public static void main(String[] args) {
        ...
        Empleado e3 = new Empleado(35, "Jose Medina", "otra cosa", "otro cosa");
        Empleado e4 = new Empleado(55, "Jose Medina", "otra cosa", "otro cosa");
        Empleado e5 = new Empleado(15, "Jose Medina", "otra cosa", "otro cosa");
        ...
        bst.preorden();
        //colocado para el cambio desde otro branch
        bst.eliminar(44);
        bst.preorden();
    }
